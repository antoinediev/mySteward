...
serveur : libs/mySteward_serveur.o serveur/serveur.c
	gcc -L/usr/local/opt/openssl/lib -I/usr/local/mysql/include libs/mySteward_serveur.o serveur/serveur.c -o serveur/serveur `mysql_config --libs` 

libs/mySteward_serveur.o : libs/mySteward_serveur.c headers/mySteward.h 
	gcc -c -I/usr/local/mysql/include libs/mySteward_serveur.c `mysql_config --cflags` 
